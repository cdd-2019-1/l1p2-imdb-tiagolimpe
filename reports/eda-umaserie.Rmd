...
Avaliar os dados das séries Friends e That '70s Show para responder algumas questões propostas antes, das quais foram escolhidas as seguintes: "Qual a melhor temporada de cada série analisada?" e "Qual a pior temporada da série analisada?"
...
## Analisando o rating por temporada
...
```
## Questão 1: Qual a melhor temporada de cada série analisada?
...
## Questão 2: Qual a pior temporada de cada série analisada?
...
Não necessariamente, vamos observar no gráfico a seguir:
...
O melhor episódio de Friends está localizado próximo ao episódio 100, isto equivale a quarta ou quinta temporada. E a melhor temporada de Friends é a última. O mesmo para That '70s Show, onde podemos ver no gráfico que o melhor episódio é localizado nos últimos episódios, isto é, na última temporada. Tal temporada é a pior avaliada da série. Então podemos concluir que o melhor episódio não está necessariamente na melhor temporada.